...
Install-ChocolatyAndPackages {
    ...
    Write-Log "choco install -y quicktime"
...
Set-InitConfig{
    ...
    Write-Log "Turning off Windows Fast User Switching "
    New-ItemProperty -path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -name HideFastUserSwitching -Value 1 -Type DWORD -Force
